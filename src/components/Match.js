    ...
    <div className={homePageCss.home}>
      <div className={homePageCss.heroSection}>
        <div className={homePageCss.heroContainer}>
          ...
          <div className={homePageCss.todayMatch}>
            <h1 className={homePageCss.todayMatchHeader}>Today's Match</h1>
            <div className={homePageCss.todayTeams}>
              <div className={homePageCss.team}>
                <img
                  ...
                  alt="Teams"
                />
                <h4 className={homePageCss.teamName}>{teamA?.name}</h4>
              </div>
              <div className={homePageCss.teamVS}>
                <img className={homePageCss.vsImage} src={vsImage} alt="vs" />
              </div>
              <div className={homePageCss.team}>
                <img
                  className={homePageCss.teamImage}
                  ...
                  alt="Teams"
                />
                <h4 className={homePageCss.teamName}>{teamB?.name}</h4>
              </div>
            </div>
            <Prediction match={todayMatch} teamA={teamA} teamB={teamB} />
          </div>
        </div>
      </div>
      <div className={homePageCss.matches}>
        <div className={homePageCss.matchesContainer}>
          <h2 className={homePageCss.upcomingMatcheHeader}>Upcoming Matches</h2>
          <div className={homePageCss.upcoming}>
            {upcomingMatches.map((match) => {
              return (
                <div className={homePageCss.upcomingMatch} key={match.id}>
                  ...
                  <div className={homePageCss.upcomingTeams}>
                    {match?.teams.map((teamId) => {
                      return (
                        <div className={homePageCss.upcomingTeam} key={teamId}>
                          <img
                            src={teamImage}
                            className={homePageCss.upcomingTeamImage}
                            alt="team"
                          />
                          <p className={homePageCss.upcomingTeamName}>
                            {teams[teamId]?.name}
                          </p>
                        </div>
                      );
                  ...
                  <span className={homePageCss.upcomingVS}>
                    &#127951; {teams[match.teams[0]]?.name} vs{" "}
                    {teams[match?.teams[1]].name}
                  </span>
                  <span className={homePageCss.goToPrediction}>
                    Make a Prediction
                  </span>
                </div>
              );
      ...
      <div className={homePageCss.leaderboard}>
        <div className={homePageCss.leaderboardContainer}>
          <h2 className={homePageCss.leaderboardHeader}>Top Players</h2>
          <div className={homePageCss.leaderboardTableHeader}>
            <span className={homePageCss.leaderboardTableName}>Name</span>
            <span className={homePageCss.leaderboardTableScore}>Score</span>
          </div>
          <ol className={homePageCss.leaders}>
            {leaderBoard?.map((user) => {
              return (
                <li className={homePageCss.leaderBoardUser} key={user.id}>
                  <span className={homePageCss.leaderboardName}>
                    <img
                      src={teamImage}
                      className={homePageCss.leaderboardImage}
                      alt="user"
                    />
                    {user.name}
                  </span>
                  <span className={homePageCss.leaderboardScore}>
                    {user.score}
                  </span>
                </li>
              );
